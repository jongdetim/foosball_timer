...
def	handle_shotcount():
	if shot_amount.get() == 3:
		probslider1.place(x=260, y=50)
		probslider2.place(x=260, y=100)
		probslider3.place(x=260, y=150)
	...
	if shot_amount.get() == 5:
		...
		probslider2.place(x=260, y=100)
		probslider3.place(x=260, y=150)
		probslider4.place(x=260, y=200)
		probslider5.place(x=260, y=250)
		probslider6.place_forget()
		probslider7.place_forget()
	if shot_amount.get() == 7:
		...
		probslider4.place(x=260, y=200)
		probslider5.place(x=260, y=250)
		probslider6.place(x=260, y=300)
		probslider7.place(x=260, y=350)
...
twobarframe = Frame(mainwindow, width=450, height=400)
twobarframe.grid(row=2, column=0)
threebarframe = Frame(mainwindow, width=450, height=400)
threebarframe.grid(row=2, column=0)
fivebarframe = Frame(mainwindow, width=450, height=400)
...
probslider1 = Scale(threebarframe, from_=0, to=10, length=120, orient='horizontal', resolution=1, variable=probs[0])
probslider2 = Scale(threebarframe, from_=0, to=10, length=120, orient='horizontal', resolution=1, variable=probs[1])
probslider3 = Scale(threebarframe, from_=0, to=10, length=120, orient='horizontal', resolution=1, variable=probs[2])
probslider4 = Scale(threebarframe, from_=0, to=10, length=120, orient='horizontal', resolution=1, variable=probs[3])
probslider5 = Scale(threebarframe, from_=0, to=10, length=120, orient='horizontal', resolution=1, variable=probs[4])
probslider6 = Scale(threebarframe, from_=0, to=10, length=120, orient='horizontal', resolution=1, variable=probs[5])
probslider7 = Scale(threebarframe, from_=0, to=10, length=120, orient='horizontal', resolution=1, variable=probs[6])
...
stick_radio_label.place(x=80, y=30)
stick_radio_1 = Radiobutton(fivebarframe, text='3', variable=shot_amount, value=3)
stick_radio_1.place(x=210, y=30)
stick_radio_2 = Radiobutton(fivebarframe, text='5', variable=shot_amount, value=5)
stick_radio_2.place(x=270, y=30)
stick_radio_3 = Radiobutton(fivebarframe, text='6', variable=shot_amount, value=6)
stick_radio_3.place(x=330, y=30)
